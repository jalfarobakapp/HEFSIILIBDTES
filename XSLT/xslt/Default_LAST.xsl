...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:sii="http://www.sii.cl/SiiDte" exclude-result-prefixes="sii">
  ...
  <!-- PARAMEROS INTERNOS -->
  <xsl:param name="SIIDireccionRegional">S.I.I.- CONCEPCIÓN</xsl:param>
  <xsl:param name="PrefijoFecha">CONCEPCIÓN</xsl:param>
    ...
    <xsl:variable name="resultado">
      <xsl:choose>
        ...
        <xsl:when test="$tip='52'">GUÍA DE DESPACHO ELECTRÓNICA</xsl:when>
    		<xsl:when test="$tip='39'">BOLETA ELECTRÓNICA</xsl:when>
        <xsl:when test="$tip='41'">BOLETA EXENTA ELECTRÓNICA</xsl:when>
  ...
  <xsl:template name="HeaderDocumento">
    ...
    <table class="HeaderDocumento" border="0px">
      ...
      <tr>
        <td>
          ...
          <table border="0px" style="width:100%" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td>
                ...
                <div class="TextoGrande">
                  ...
                  <br/>
                  <div class="TextoGiro">
                    ENSENANZA Y PRACTICA GIMNASIA Y OTRAS DISCIPLINAS DEPORTIVA<BR/>
            ...
            Casa matriz:<br/>
            Dirección:   COCHRANE 635, Bloque A, Depto. 101<br/>
            Comuna:  CONCEPCIÓN<br/>
            Ciudad:  CONCEPCIÓN<br/>
      ...
      <tr>
        <td colspan="2">
          Sucursales:<br/>
          RUTA 225, KM 1.5 63, Villa/Pob. C.COMERCIAL DONA EMA, Ciudad PUERTO VARAS, Comuna PUERTO VARAS -
          COCHRANE 635, Depto. 105, Villa/Pob. TORRE A, Ciudad CONCEPCION, Comuna CONCEPCION -
          AVENIDA ALEMANIA 990, Ciudad LOS ANGELES, Comuna LOS ANGELES -
          LOS CARRERA PONIENTE 301, Bloque GN, Depto. 200, Villa/Pob. CONCEPCION, Ciudad CONCEPCION, Comuna CONCEPCION -
          AV. ARTURO PRAT 199, Bloque A, Depto. 301, Ciudad CONCEPCION, Comuna CONCEPCION -
          EJERCITO 395, Depto. A-1, Villa/Pob. RAHUE BAJO, Ciudad OSORNO, Comuna OSORNO -
          AVENIDA EGANA 1151, Depto. 1 Y 2, Ciudad PUERTO MONTT, Comuna PUERTO MONTT -
          CIRCUNVALACION ORIENTE 1055, Depto. 301, Ciudad TALCA, Comuna TALCA -
          AVDA. JORGE ALESSANDRI 3177, Bloque H, Depto. 281, Ciudad TALCAHUANO, Comuna TALCAHUANO -
          AV. LAGUNA GRANDE 115, Depto. 29, Villa/Pob. SAN PEDRO DEL VALLE, Ciudad CONCEPCION, Comuna SAN PEDRO DE LA PAZ -
          AVDA. JORGE ALESANDRI 3177, Depto. L9-10, Ciudad CONCEPCION, Comuna TALCAHUANO -
          COLO COLO 563, Ciudad LOS ANGELES, Comuna LOS ANGELES -
          COCHRANE 635, Bloque A, Depto. 1601, Ciudad CONCEPCION, Comuna CONCEPCION
  ...
  <xsl:template name="TimbreElectronico">
    ...
    <div class="TimbreElectronico">
      ...
      <div style="text-align:center;padding-top:0px;">&#160;&#160;&#160;&#160;&#160;&#160;Res. 80 de 2014 Verifique documento: http://www.FERSANATURA.cl/Boletas/ </div>
    </div>
  </xsl:template>
